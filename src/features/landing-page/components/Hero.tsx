...
export function Hero() {
  return (
    <div className="relative flex flex-col items-center justify-center p-8 overflow-hidden rounded-lg">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          >
            <button className="bg-google-red-500 hover:bg-google-red-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg text-lg transition duration-300 ease-in-out transform hover:-translate-y-1 flex items-center justify-center gap-2">
              {' '}
              {/* Updated button style and added flex for icon */}
